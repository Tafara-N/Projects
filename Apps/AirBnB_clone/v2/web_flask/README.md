...
- All your files should end with a new line
- A `README.md` file at the root of the folder of the project is mandatory
- Your code should be [W3C compliant](https://intranet.alxswe.com/rltoken/_bfSTiq2t4otmyPespKhEg) and validate with W3C-Validator (except for jinja template)
...
![Cities by states](8-cities_by_states.jpg)
...
![11. HBNB filters](task_11_image2.jpg)

![11. HBNB filters](task_11_image3.jpg)
